<!-- ======= Start package/admin/CHANGEPROFILE.PHP ======= -->
...
if (isset($_POST["update_data"])) {
    ...
    if(empty($photo_name)
        ...
        $sql = "UPDATE tbl_user SET u_fname='$up_fname', u_mname='$up_mname',
                                    ...
                                    u_contact='$up_contact', u_address='$up_address' WHERE u_id='{$_SESSION["A_ID"]}'";
        ...
        if ($photo_size > 5242880) {
            ...
            $sql = "UPDATE tbl_user SET u_fname='$up_fname', u_mname='$up_mname',
                                        u_lname='$up_lname', u_email='$up_email', 
                                        u_contact='$up_contact', u_address='$up_address', u_photo='$photo_new_name' WHERE u_id='{$_SESSION["A_ID"]}'";
...
<!-- ======= eND package/admin/CHANGEPROFILE.PHP ======= -->
