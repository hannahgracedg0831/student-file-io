<!-- ======= Start package/admin/PAGE-YEAR_SECTION.PHP ======= -->
...
<html lang="en">
    <head>
        ...
        <title>Year and Section | RCNHS</title>
                ...
                <div class="sidebar-inner slimscroll">
					...
					<hr>
						...
						<li class="menu-title"> 
							...
							<li><a href="page-year_section.php" style="background-color: #FFA600;"><font color="black"><strong><i class="fa fa-th-large"></i> <span> Set Year and Section</span></strong></font></a></li>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Set Year and Section</h3>
									<ul class="breadcrumb">
										<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
										<li class="breadcrumb-item active">Set Year and Section</li>
									</ul>
							</div>
						</div>
					</div>
                    ...
                    <div class="alert alert-warning">
						<i class="fa fa-info-circle"></i>&nbsp; 
                            <strong>GUIDE |</strong> &nbsp;Manage Year-Section. ( Search / Add / Delete ).
				    </div>
					...
					<?php
						...
						if(isset($_POST['searchBtn'])
							...
							$query = mysqli_query($conn, "SELECT * FROM `tbl_yearsection` WHERE created_at BETWEEN '$newFromDate' AND '$newToDate'") or die(mysqli_error($conn));

						} else {
							$query = mysqli_query($conn, "SELECT * FROM `tbl_yearsection`") or die(mysqli_error($conn));
						}
				...
				<div class="row">
					<div class="col-md-12">
						<form method="POST" action="add-yearsection.php">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<select class="form-control" name="std_year" required>
										<option selected disabled value="">&larr; Select Year &rarr;</option>
								...
								<div class="col-md-4">
									<div class="form-group">
									<input type="text" name="std_section" class="form-control" placeholder="Section" required="required"/>        
									</div>
								</div>
			...
			<table id = "table" class="table table-bordered">
				...
				<tbody>
					<?php while($fetch = mysqli_fetch_array($query) ){?>
						...
						<tr class="del_ys<?php echo $fetch['ys_id'] ?>">
                            <td class="text-center"><?php echo $fetch['ys_yearsection'] ?></td>

							<td class="text-center">	
								<div class="dropdown dropdown-action">
									<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item btn-delete" id="<?php echo $fetch['ys_id']?>" type="button"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
										</div>
								</div>
							</td>
						</tr>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('.btn-delete').on('click', function(){
					var ys_id = $(this).attr('id');
					$("#modal_confirm").modal('show');
					$('#btn_yes').attr('name', ys_id);
				});
				$('#btn_yes').on('click', function(){
					var id = $(this).attr('name');
					$.ajax({
						type: "POST",
						url: "delete-yearsection.php",
						data:{
							ys_id: id
						},
						success: function(){
							...
							$(".del_ys" + id).empty();
							$(".del_ys" + id).html("<td colspan='6'><center class='text-danger'>Deleting...</center></td>");
							setTimeout(function(){
								$(".del_ys" + id).fadeOut('slow');
							}, 1000);
						}
					});
				});
...
<!-- ======= EnD package/admin/PAGE-YEAR_SECTION.PHP ======= -->
