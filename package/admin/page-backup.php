<!-- ======= Start package/admin/PAGE-BACKUP.PHP ======= -->
                ...
                <div class="content container-fluid">
                    ...
                    <div class="alert alert-warning">
						<i class="fa fa-info-circle"></i>&nbsp; 
                            <strong>GUIDE |</strong> &nbsp; Manage Backup files. ( Download ).
				    </div>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
											<li class="nav-item"><a class="nav-link active" href="#bottom-justified-tab1" data-toggle="tab">Backup</a></li>
											<li class="nav-item"><a class="nav-link" href="page-restore.php">Restore</a></li>
										</ul>
								...
								<div class="col-sm-2 col-md-6"> 
									<div class="form-group form-focus select-focus">
										<a href="extension.php"><button class="btn btn-success btn-block" onclick="myFunction()" >&nbsp Download All Database File</button></a>
									</div>
								</div>
...
<!-- ======= End package/admin/PAGE-BACKUP.PHP ======= -->
