<!-- ======= Start package/admin/PAGE-TEACHERYEAR.PHP ======= -->
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="row">
						...
						if(isset($_POST['searchBtn'])
							...
							$query = mysqli_query($conn, "SELECT * FROM `students_data` WHERE datetime BETWEEN '$newFromDate' AND '$newToDate'") or die(mysqli_error($conn));

						} else {
							$query = mysqli_query($conn, "SELECT * FROM `students_data`") or die(mysqli_error($conn));
						}
				...
				<div class="row">
                    ...
                    <?php
						...
						$sql = "SELECT u_id, u_fname, u_lname FROM tbl_user WHERE u_role='TEACHER'";
					...
					?>
                                                <div class="col-md-4">
													...
													<?php foreach($results as $output) {?>
														<option value="<?php echo $output["u_id"].' - '.$output["u_fname"].' '.$output["u_lname"]; ?>"></option>
														<?php } ?>
					...
					?>
												<div class="col-md-4">
                                                    ...
                                                    <select class="form-control" name="ys_yearsection" required>
...
<!-- ======= End package/admin/PAGE-TEACHERYEAR.PHP ======= -->
