<!-- ======= Start package/admin/PAGE-ARCHIVETEACHER.PHP ======= -->
                ...
                <div class="content container-fluid">
					...
					<div class="card">
						<div class="card-body">
							<ul class="nav nav-tabs nav-tabs-bottom">
								<li class="nav-item"><a class="nav-link active" href="page-archiveTeacher.php">Document Table View</a></li>
                                <li class="nav-item"><a class="nav-link" href="page-archiveFolderView.php">Document Folder View</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="row">
						...
						if(isset($_POST['searchBtn'])
							...
							$query = mysqli_query($conn, "SELECT * FROM `tbl_teacherdocuments`");
			...
			<table id = "table" class="table table-bordered">
				<thead>
					<tr>
						...
						<th class="text-center">Document Classification</th>
					...
					<?php while($fetch = mysqli_fetch_array($query) ){?>
						...
						<tr class="del_tdoc<?php echo $fetch['tdoc_id'] ?>">
							<td class="text-center">
								...
								?>
								<a title="Click this to download" href="<?php echo $fetch['tdoc_path'] ?>" download="<?php echo $fetch['tdoc_title'] . ".".$extension ?>">
									<?php echo $fetch['tdoc_title'] ?>
								</a>
							</td>
							<td class="text-center"><?php echo $fetch['tdoc_description'] ?></td>
							<td class="text-center"><?php echo $fetch['tdoc_path'] ?></td>
							<td class="text-center"><?php echo $fetch['tdoc_classification'] ?></td>
							<td class="text-center"><?php echo $fetch['tdoc_tag'] ?></td>
                            <td class="text-center"><?php echo $fetch['tdoc_yearsection'] ?></td>
							<td class="text-center"><?php echo $fetch['tdoc_schoolyear'] ?></td>
						</tr>
...
<!-- ======= End package/admin/PAGE-ARCHIVETEACHER.PHP ======= -->
