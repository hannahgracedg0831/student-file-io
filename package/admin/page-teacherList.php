<!-- ======= Start package/admin/PAGE-TEACHERLIST.PHP ======= -->
                ...
                <div class="sidebar-inner slimscroll">
					...
					<hr>
						...
						<li class="menu-title"> 
							...
							<li><a href="page-teacherList.php" style="background-color: #FFA600;"><font color="black"><strong><i class="fa fa-th-large"></i> <span> Manage Teacher</span></strong></font></a></li>
                ...
                <div class="content container-fluid">
                    ...
                    <div class="alert alert-warning">
						<i class="fa fa-info-circle"></i>&nbsp; 
                            <strong>GUIDE |</strong> &nbsp;(Advisory) Manage Teachers Year-Section and Teachers School Year Level . ( Search / Edit / Delete ).
                            &nbsp;<a href="page-pendingAccount.php" class="btn btn-success" >Teachers Pending Account</a>
				    </div>
					...
					<?php
						...
						if(isset($_POST['searchBtn'])
							...
							$query = mysqli_query($conn, "SELECT * FROM `tbl_user` WHERE u_role = 'TEACHER' AND u_status = 'Active'") or die(mysqli_error($conn));
						}
			...
			<table id = "table" class="table table-bordered">
				...
				<tbody>
					<?php while($fetch = mysqli_fetch_array($query) ){
						...
						<tr class="del_u<?php echo $fetch['u_id'] ?>">
						<td class="text-center"><input type="checkbox" onchange="updateSelectedStudents();" name="studentId" value="<?php echo $fetch['u_id'] ?>"></td>
							<td class="text-center"><?php echo $name; ?></td>
							<td class="text-center"><?php echo $fetch['u_email']?></td>
							<td class="text-center"><?php echo $fetch['u_role']?></td>
							<td class="text-center"><?php echo $fetch['u_gender']?></td>
			...
			<div class="modal fade" id="edit_modal<?php echo $fetch['u_id']?>" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						<form method="POST" action="update-teacherList.php">	
			...
			<div class="modal fade" id="modal_confirm" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-body">
							<center><h3 class="text-danger">Are you sure you want to delete this teacher?</h3></center>
						</div>
						<div class="modal-footer">
					...
					<div class="col-md-6">
						...
						<div class="card">
							<div class="card-body">
								<div class="card-box">
					<div class="col-md-12">
                                        <form method="POST" action="update-allYSteacher.php">
					...
					<div class="col-md-6">
						<div class="card">
							<div class="card-body">
								<div class="card-box">
					<div class="col-md-12">
                                        <form method="POST" action="update-allSYteacher.php">
										<input type="hidden" class="selectedStudents" name="selectedStudents" class="form-control"/>
                                            <div class="row">
				...
				$('#btn_yes').on('click', function(){
					...
					$.ajax({
						...
						success: function(){
							...
							$(".del_u" + id).empty();
							$(".del_u" + id).html("<td colspan='6'><center class='text-danger'>Deleting...</center></td>");
							setTimeout(function(){
								$(".del_u" + id).fadeOut('slow');
							}, 1000);
						}
					});
				});
...
<!-- ======= End package/admin/PAGE-TEACHERLIST.PHP ======= -->
