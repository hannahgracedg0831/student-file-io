...
Dynamsoft.OnWebTwainNotFoundOnLinuxCallback = function (ProductName, strDebUrl, strRpmUrl, bHTML5, bIE, bSafari, bSSL, strIEVersion) {
    ...
    _this._show_install_dialog(ProductName, objUrl, bHTML5, Dynamsoft.DWT.EnumDWT_PlatformType.enumLinux, bIE, bSafari, bSSL, strIEVersion, true);
};
...
Dynamsoft.OnLTSConnectionWarning = function () {
  ...
  var ObjString = [
    '<div class="dynamsoft-dialog dynamsoft-dialog2">',
    '<div class="dynamsoft-dwt-ltsdlg-header"><span style="color:#FFF;line-height:35px;margin-left:15px">Warning</span><div class="dynamsoft-dialog-close"></div></div>',
    '<div class="dynamsoft-dwt-ltsdlg-body">',
...
Dynamsoft.OnHTTPCorsError = function () {
  ...
  var ObjString = [
    '<div class="dynamsoft-dialog dynamsoft-dialog2">',
    '<div class="dynamsoft-dwt-ltsdlg-header"><span style="color:#FFF;line-height:35px;margin-left:15px">Warning</span><div class="dynamsoft-dialog-close"></div></div>',
    '<div class="dynamsoft-dwt-ltsdlg-body" style="padding:25px 50px 20px 50px;">',
