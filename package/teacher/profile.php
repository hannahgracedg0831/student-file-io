<!-- ======= Start package/teacher/PROFILE.PHP ======= -->
    ...
    <body>
        ...
        <div class="main-wrapper">
			...
			<?php 	include('config.php');
				...
				$select_sql = "SELECT * FROM tbl_user WHERE u_id='{$_SESSION["T_ID"]}'";
									...
									<div class="profile-view">
										<div class="profile-img-wrap">
											<div class="profile-img">
												<a href="#"><img src="../images/<?php echo $_SESSION["T_Profile"]; ?>" alt=""></a>
											</div>
										</div>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														<li>
															...
															<div class="text"><?php echo $_SESSION["T_Role"]; ?></div>
														</li>
														<li>
		...
		<?php 	include('config.php');
			...
			$update_sql = "SELECT * FROM tbl_user WHERE u_id='{$_SESSION["T_ID"]}'";
							...
							<div class="alert alert-info">
								...
								<div class="row">
									...
									<div class="form-group">
											...
											<input type="text" class="form-control" readonly="" value="<?php echo $_SESSION["T_Role"]; ?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
...
<!-- ======= End package/teacher/PROFILE.PHP ======= -->
