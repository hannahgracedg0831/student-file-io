<!-- ======= Start package/teacher/PAGE-TEACHERDOCUMENT.PHP ======= -->
...
<html lang="en">
    <head>
        ...
        <title>Archive File | RCNHS</title>
					...
					<div class="card">
						<div class="card-body">
							...
							<ul class="nav nav-tabs nav-tabs-bottom">
								<li class="nav-item"><a class="nav-link active" href="page-teacherDocument.php">Document Table View</a></li>
								<li class="nav-item"><a class="nav-link" href="view-teacherDocument.php">Document Folder View</a></li>
					...
					<?php while($fetch = mysqli_fetch_array($query) ){?>
						...
						<tr class="del_tdoc<?php echo $fetch['tdoc_id'] ?>">
							<td class="text-center">
								...
								?>
								<a href="<?php echo $fetch['tdoc_path'] ?>" download="<?php echo $fetch['tdoc_title'] . ".".$extension ?>">
							...
							<div class="modal-body">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<input type="hidden" name="tdoc_id" value="<?php echo $fetch['tdoc_id']?>" class="form- "/>
												<label>Title</label>
...
<!-- ======= End package/teacher/PAGE-TEACHERDOCUMENT.PHP ======= -->
